...
% Script: K-data_process_20131027.R

echo "K-data: run OCR"
for i in {1..10}
do
%	tesseract K-data_processed/K-data_half_linesremoved_$i.png -l fin K-data_processed/K-data_half_linesremoved_$i
%	tesseract K-data_processed/K-data_half_linesremoved_$i.png -l fin -psm 6 K-data_processed/K-data_half_linesremoved_$i
...
%	tesseract K-data_processed/K-data_half_linesremoved_$i.png -l fin -psm 6 K-data_processed/K-data_half_linesremoved_$i juuso
done
